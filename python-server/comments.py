...
app_secret = config.app_secret  # DO NOT SHARE WITH ANYONE!
file_id = "DonaldTrump"
...
def scrapeFacebookPageFeedComments(page_id, access_token):
    with open('data/%s_facebook_comments.csv' % file_id, 'wb') as file:
        w = csv.writer(file)
        ...
        with open('data/%s_facebook_statuses.csv' % file_id, 'rb') as csvfile:
